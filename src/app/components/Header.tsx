...
const Header = () => {
    return (
        <div className='relative h-[90svh] ipad:h-[90svh] grid place-items-center '>
            ...
            <div className="absolute sm:block hidden right-[10%] top-[15%]"><GiFingerPrint style={style1} /></div>
            ...
            <div className='container relative mx-auto flex flex-col justify-between min-h-full'>
                ...
                <Link href="/registration" className=' max-w-[250px] tablet:max-w-[360px] w-full mx-auto flex-grow'><FullWidthButton label='Register Now' color='#0B1237'  /></Link>
            </div>
