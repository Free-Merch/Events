        ...
        <div className='container mx-auto mt-[80px] mb-[115px] sm:mb-[55px]'>
            <div className='flex  justify-around md:flex-nowrap flex-wrap items-start'>
                <div className='sm:w-[45%] order-2 w-[100%] h-auto  mx-[20px] sm:mx-auto'>
                    <p className='text-[#3DB5E6] mt-[60px] sm:mt-[25px] uppercase underline  text-left]'>About this event</p>
                    <h1 className='font-[800] font-ppneue text-[32px] sm:mt-[41px] mt-[20px] whitespace-wrap  sm:text-left tracking-[0.48px] text-left mb-[20px] sm:mb-[38px]'>We are building ABC</h1>
                    <p className='text-left font-satoshi font-[500] text-[16px] leading-[27px] sm:leading-[27px] tracking-[0.32px]'>
